---
title: redis-推荐规范1
cover_img: 'http://qiniucdn.timilong.com/155152111314.jpg'
date: 2019-08-19 16:06:15
tags: Redis
feature_img: 
description: 摘自阿里云的Redis开发规范.
keywords: Redis
categories: Redis
---
...
> 转载自: https://yq.aliyun.com/articles/531067#cc1
...
例如: 
一个200万的zset设置1小时过期，会触发del操作，造成阻塞，而且该操作不会不出现在慢查询中(latency可查))，查找方法和删除方法
...
[Jedis常见异常汇总](https://yq.aliyun.com/go/articleRenderRedirect?spm=a2c4e.11153940.0.0.1e33744agTeu0n&url=https%3A%2F%2Fyq.aliyun.com%2Farticles%2F236384)
[JedisPool资源池优化](https://yq.aliyun.com/go/articleRenderRedirect?spm=a2c4e.11153940.0.0.1e33744agTeu0n&url=https%3A%2F%2Fyq.aliyun.com%2Farticles%2F236383)

3. 高并发下建议客户端添加熔断功能(例如netflix hystrix)
4. 设置合理的密码，如有必要可以使用SSL加密访问（阿里云Redis支持）
